...
- Version 0.3.6 mirrors the same restricted tweak into `/usr/lib/TweakInject` when RootHide is present, while keeping the normal rootless `/var/jb/Library/MobileSubstrate/DynamicLibraries` install path unchanged.
